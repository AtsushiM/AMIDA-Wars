enchant();
var AW=function(F){var aa=function(){0===F.pageYOffset&&F.scrollTo(0,1)};F.onorientationchange=function(){setTimeout(aa,100)};F.addEventListener("load",F.onorientationchange,!1);var m,P,u={USER:{UNIT:new Group,CASTLE:new Group,THUMB:new Group},ENEMY:{UNIT:new Group,CASTLE:new Group,THUMB:new Group},MAP_OPTION:{CASTLE_BASE:new Group,THUMB_BASE:new Group},EFFECT:{UNIT:new Group}},C="",B={USER:{},ENEMY:{},no:0},Q={USER:[],ENEMY:[]},x={USER:[],ENEMY:[]},M={},J={},N={},O=[],G={USER:[],ENEMY:[]},R=[],D=
...
g=Q.USER,i=CONST_CASH.HAVE.USER,j=b.USER.POSITION,k=b.FRAME;C=a.race;e=a.order;c=0;for(d=e.length;c<d;c++)a=e[c].toUpperCase(),f=j[c],g[c]=new T({mode:i,name:a,frame:k[C][a],x:f[0],y:f[1]});h.text="\u2462";h.font="150px/1.5 "+CONST_CASH.FONT;h.color="#fff";h.x=90;h.y=100;m.rootScene.addChild(h);N.init();m.popScene();aid=setTimeout(function(){h.text="\u2461";aid=setTimeout(function(){h.text="\u2460";aid=setTimeout(function(){D.vibrate(3);c=0;for(d=e.length;c<d;c++)g[c].init();q.init();E.init();J.init();
...
function(a){s=a.frame;return true};p=function(){return D.getSquere(d)};d.beforePoint=p();v=function(){var a=false;if(e>=h){var b,c=d.beforePoint;e=e-h;if(e>0){switch(d.direction){case 0:d.y=d.y+e;break;case 1:d.x=d.x-e;break;case 2:d.y=d.y-e;break;case 3:d.x=d.x+e}d.y=Math.round(d.y);d.x=Math.round(d.x)}e=0;b=p();if(b.x!==c.x||b.y!==c.y)a=true}return a};t=function(){return D.getCollision(d)};w=function(){if(m.frame%5===0){l++;switch(l){case 4:l=0;r=-1;break;case 3:r=0}r++}d.frame=s+r*k+d.direction};
...
k);j.removeChild(f);f.endFlg=!0;setTimeout(function(){a=h=i=e=g=c=d=j=f=k=null},10);return!0};return A({layer:j,sprite:f})},E={aiid:null,race:"",order:[],init:function(){var b=E,a=CONST_CASH.HAVE.ENEMY,h,i,e,g=x.ENEMY,c=g.length,d=CONST_CASH.UNIT.STATUS,j,f,k;switch(C){case "HUMAN":b.race="UNDEAD";b.order="BONE_DOG,BONE_WARRIER,BONE_ARCHER,SHADE,BONE_SNAKE,GOLEM,SPECTOR,ARACHNE".split(",");break;default:b.race="HUMAN",b.order="LANCER,WARRIOR,KNIGHT,ARCHER,CLELIC,FIRE_MAGE,FROST_MAGE,WIZARD".split(",")}d=
d[b.race];j=b.order;b.aiid=setInterval(function(){f=j.length;0<f&&(e=Math.floor(Math.random()*c),e>=c&&(e=c-1),h=g[e],e=Math.floor(Math.random()*f),e>=f&&(e=f-1),k=j[e],i=d[k],j.splice(e,1),e={mode:a,direction:2,x:h.unitX,y:h.unitY,after_death:function(a){j.push(a.name)}},e=z(e,i),i=new I(e))},6E3)},end:function(){clearInterval(E.aiid);E.aiid=null}},y={init:function(){var b=function(){var a=B.USER,h=B.ENEMY,i,e,g,c;b=function(){for(g in h)if(!0===h.hasOwnProperty(g))for(c in e=h[g],a)!0===a.hasOwnProperty(c)&&
...
y.score(b));!0===a.checkDeath()&&(q.death(a),y.score(a));D.vibrate(1)},siege:function(b,a){q.siege(a);a.damage(b);b.kill();D.vibrate(3);!0===a.checkBreak()&&(q.castle(a),y.score(a))}},t={functions:{},exefunc:function(){var b,a=[],h=t.functions;for(b in h)!0===h.hasOwnProperty(b)&&a.push(h[b]());return a},add:function(b,a){t.functions[a]=b},remove:function(b){delete t.functions[b]},init:function(){m.addEventListener(enchant.Event.ENTER_FRAME,t.exefunc,!1)},stop:function(){m.removeEventListener(enchant.Event.ENTER_FRAME,
